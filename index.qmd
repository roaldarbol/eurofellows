...
format: 
  html:
    ...
    header-includes: |
      ...
      <script async data-nf='{"formurl":"https://opnform.com/forms/european-fellowships-gqocnm","emoji":"📝","position":"right","bgcolor":"#3B82F6","width":800}' src='https://opnform.com/widgets/embed-min.js'></script>
...
fellowship_table <- reactable(
  ...
  columns = list(
    ...
    eligible_nationalities_from_or_not = colDef(show = FALSE),
...
function remove_all_option() {
  document.getElementById("eligible_host_location").getElementsByClassName("selectized")[0].selectize.removeOption("");
  document.getElementById("eligible_fields").getElementsByClassName("selectized")[0].selectize.removeOption("");
  document.getElementById("eligible_nationalities").getElementsByClassName("selectized")[0].selectize.removeOption("");
}
